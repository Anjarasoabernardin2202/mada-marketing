      ...
      <Card.Body>
        <Row className="d-block d-xl-flex align-items-center">
          ...
          <Col xs={12} xl={7} className="px-xl-0">
            ...
            <small>{period}, <FontAwesomeIcon icon={faGlobeEurope} size="xs" /> Prochaine Formation</small>
...
export const TeamMembersWidget = () => {
  const TeamMember = (props) => {
    ...
    const status = {
      online: { color: "success", label: "Disponible" },
      inMeeting: { color: "warning", label: "Occuper" },
      offline: { color: "danger", label: "Absent" }
    };
  ...
  return (
    <Card border="light" className="shadow-sm">
      <Card.Header className="border-bottom border-light d-flex justify-content-between">
        <h5 className="mb-0">Membre (admin)</h5>
    ...
    <Card className="bg-secondary-alt shadow-sm">
      <Card.Header className="d-flex flex-row align-items-center flex-0">
        ...
        <div className="d-flex ms-auto">
          <Button variant="secondary" size="sm" className="me-2">Mois</Button>
          <Button variant="primary" size="sm" className="me-3">Semaines</Button>
        </div>
      </Card.Header>
      <Card.Body className="p-2">
        <SalesValueChart />
